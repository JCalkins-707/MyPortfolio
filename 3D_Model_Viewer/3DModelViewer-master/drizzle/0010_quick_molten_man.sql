...
INSERT INTO `__new_model`("model_id", "uploader_id", "title", "uploadDate", "license", "file_path", "description", "metadata", "approved", "deleted") SELECT "model_id", "uploader_id", "title", "uploadDate", "license", "file_path", "description", "metadata", "approved", "deleted" FROM `model`;--> statement-breakpoint
